...
* #BBA "Biobank" "Dieses Konzept soll für Dokumente verwendet werden, die im interdisziplinären Tätigkeitsfeld von zentralen klinischen oder populationsbasierten Biobanken generiert wurden, auch wenn die Biobank organisatorisch zum Beispiel Teil einer Klinischen Pathologie oder Kardiologie ist. Biobanken sind interdisziplinäre Infrastrukturen, die biologisches Probenmaterial und zugehörige Daten nach standardisierten, qualitätsgesicherten Prozessen sammeln, erfassen, verarbeiten, charakterisieren, sicher lagern bzw. speichern und kontrolliert für Forschungsvorhaben verfügbar machen. Sie arbeiten an der Nahtstelle zwischen Patientenversorgung und biomedizinischer Forschung und verbinden klinische Medizin, Molekularbiologie, Epidemiologie, Informatik, Qualitätssicherung, Datenschutzmanagement sowie Recht und Ethik, um reproduzierbare Erkenntnisse für Präzisionsmedizin, Translation und Public Health zu ermöglichen."
