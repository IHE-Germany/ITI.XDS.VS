...
CodeSystem: PracticeSettingNonDoctoral
Id: PracticeSettingNonDoctoral
Title: "Practice Setting Non Doctoral"
Description: "**Nicht-ärztliche Fachrichtungen** (Practice Setting Non Doctoral)"

* ^url = "http://www.ihe-d.de/fhir/CodeSystem/PracticeSettingNonDoctoral"
* ^version = "0.1.0"
* ^status = #draft
* ^experimental = true
* ^date = "2024-01-24"
...
* #PRV "Prävention"
  "Die Prävention deckt die Tätigkeiten von Wellnessberatern und -beraterinnen ab; auch die Tätigkeiten von Fitnesstrainern und -trainerinnen außerhalb der medizinischen Rehabilitation oder der Sportmedizin sind durch dieses Konzept abgedeckt.
Typischerweise werden Dokumente, die von Angehörigen der folgenden Berufsgruppen erstellt werden, mit diesem Code versehen:
...
ValueSet: PracticeSettingNonDoctoral
Id: PracticeSettingNonDoctoral
Title: "Practice Setting Non Doctoral"
Description: "**Practice Setting Non Doctoral** (Nicht-ärztliche Fachrichtungen)"

* ^url = "http://www.ihe-d.de/fhir/ValueSet/PracticeSettingNonDoctoral"
* ^version = "0.1.0"
* ^status = #draft
* ^experimental = true
* ^date = "2024-01-24"
